...
__author__ = """Michael Trepanier, got help from Howard
used this source https://www.101computing.net/real-time-iss-tracker/"""
...
def IndyLocation():
    ...
    nextlocation = json.loads(response.text)
    next_time = time.ctime(nextlocation["response"][0]["risetime"])
